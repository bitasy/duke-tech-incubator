...
INSERT INTO Project(pid, founder, name, status, description) VALUES
  (1, 'Brian Nieves', 'Fake News Detector', 'inactive', 'Detects fake news!'),
  (2, 'Brian Nieves', 'Database Project', 'active', 'Our 316 project'),
  (3, 'Jeffrey Li', 'Talk like a Kiwi', 'active', 'Learn to speak like a kiwi');

INSERT INTO Mentorship(pid, professor_netid) VALUES
  (1, 'op69'),
  (2, 'op69'),
  (3, 'jk123');
